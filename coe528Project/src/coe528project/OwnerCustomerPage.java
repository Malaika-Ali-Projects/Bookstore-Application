...
public class OwnerCustomerPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ownerCustomerPageTitle.setFont(new java.awt.Font("Georgia", 1, 18)); // NOI18N
        ownerCustomerPageTitle.setForeground(new java.awt.Color(244, 225, 193));
        ownerCustomerPageTitle.setText("Customers");

        backButton.setBackground(new java.awt.Color(244, 225, 193));
        backButton.setFont(new java.awt.Font("Georgia", 0, 12)); // NOI18N
        backButton.setForeground(new java.awt.Color(92, 64, 51));
        ...
        logoutButton.setBackground(new java.awt.Color(244, 225, 193));
        logoutButton.setFont(new java.awt.Font("Georgia", 0, 12)); // NOI18N
        logoutButton.setForeground(new java.awt.Color(92, 64, 51));
        ...
        addCustomerButton.setBackground(new java.awt.Color(244, 225, 193));
        addCustomerButton.setFont(new java.awt.Font("Georgia", 0, 12)); // NOI18N
        addCustomerButton.setForeground(new java.awt.Color(92, 64, 51));
        ...
        deleteCustomerButton.setBackground(new java.awt.Color(244, 225, 193));
        deleteCustomerButton.setFont(new java.awt.Font("Georgia", 0, 12)); // NOI18N
        deleteCustomerButton.setForeground(new java.awt.Color(92, 64, 51));
        ...
        jCustomersTable.setAutoCreateRowSorter(true);
        jCustomersTable.setBackground(new java.awt.Color(244, 225, 193));
        jCustomersTable.setFont(new java.awt.Font("Georgia", 0, 12)); // NOI18N
        jCustomersTable.setForeground(new java.awt.Color(92, 64, 51));
        ...
        jCustomersTable.setFillsViewportHeight(true);
        jCustomersTable.setGridColor(new java.awt.Color(244, 225, 193));
        jCustomersTable.setShowGrid(false);
        jCustomersTable.setShowVerticalLines(false);
        ...
        jCustomersTable.getAccessibleContext().setAccessibleParent(jCustomersTable);

        newCustomerName.setBackground(new java.awt.Color(244, 225, 193));
        ...
        jLabel2.setForeground(new java.awt.Color(244, 225, 193));
        jLabel2.setText("New Customer Name");

        newCustomerPassword.setBackground(new java.awt.Color(244, 225, 193));

        jLabel1.setFont(new java.awt.Font("Georgia", 0, 12)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(244, 225, 193));
