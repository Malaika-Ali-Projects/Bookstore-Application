...
public class CustomerBookPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        topMessage.setFont(new java.awt.Font("Georgia", 1, 18)); // NOI18N
        topMessage.setForeground(new java.awt.Color(244, 225, 193));
        topMessage.setText("Welcome #! you have # points. Your status is #.");

        redeemPointsBuyButton.setBackground(new java.awt.Color(244, 225, 193));
        redeemPointsBuyButton.setFont(new java.awt.Font("Georgia", 0, 12)); // NOI18N
        redeemPointsBuyButton.setForeground(new java.awt.Color(92, 64, 51));
        ...
        buyButton.setBackground(new java.awt.Color(244, 225, 193));
        buyButton.setFont(new java.awt.Font("Georgia", 0, 12)); // NOI18N
        buyButton.setForeground(new java.awt.Color(92, 64, 51));
        ...
        jScrollPane2.setForeground(new java.awt.Color(92, 64, 51));
        jScrollPane2.setFont(new java.awt.Font("Georgia", 0, 12)); // NOI18N

        customerBookTable.setForeground(new java.awt.Color(244, 225, 193));
